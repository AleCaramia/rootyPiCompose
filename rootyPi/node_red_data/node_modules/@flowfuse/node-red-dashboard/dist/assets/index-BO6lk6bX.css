.pwa-toast[data-v-da2fdc7e]{position:fixed;right:0;bottom:0;margin:16px;padding:12px;border:1px solid #8885;background-color:rgb(var(--v-theme-background));border-radius:4px;z-index:1;text-align:left;box-shadow:3px 4px 5px #8885;display:grid}.pwa-toast .message[data-v-da2fdc7e]{margin-bottom:8px}.pwa-toast .buttons[data-v-da2fdc7e]{display:flex}.pwa-toast button[data-v-da2fdc7e]{border:1px solid #8885;outline:none;margin-right:5px;border-radius:2px;padding:3px 10px}.pwa-toast button.reload[data-v-da2fdc7e]{display:block}.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}.nrdb-ui-notification{padding-top:64px}.nrdb-ui-notification .v-snackbar__wrapper{background-color:rgb(var(--v-theme-group-background));color:rgb(var(--v-theme-on-group-background));border-left:6px solid var(--nrdb-ui-notification-color)}.nrdb-ui-notification .v-snackbar__content{padding:8px 12px}.nrdb-ui-notification-countdown{position:absolute;width:calc(100% + 6px);top:0;left:0;margin-left:-6px;border-top-left-radius:4px}.nrdb-ui-notification h1,.nrdb-ui-notification h2,.nrdb-ui-notification h3,.nrdb-ui-notification h4{margin:.5rem 0}[data-v-f053caa5] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-f053caa5] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-f053caa5]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--flex[data-v-f053caa5]{--layout-card-width: 320px;--layout-gap: 12px}.nrdb-layout--flex[data-v-f053caa5]{display:flex;flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--flex>div[data-v-f053caa5]{width:var(--layout-card-width);max-width:100%}.v-card[data-v-f053caa5]{width:100%}[data-v-8f8c4b8c] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-8f8c4b8c] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-8f8c4b8c]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--grid[data-v-8f8c4b8c]{--layout-card-width: 320px;--layout-gap: 12px;--widget-row-height: 48px}.nrdb-layout--grid[data-v-8f8c4b8c]{display:grid;grid-template-columns:repeat(12,1fr);flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--grid>div[data-v-8f8c4b8c]{width:100%}.v-card[data-v-8f8c4b8c]{width:100%}@media only screen and (max-width: 1024px){.nrdb-layout--grid[data-v-8f8c4b8c]{grid-template-columns:repeat(9,1fr)}}@media only screen and (max-width: 768px){.nrdb-layout--grid[data-v-8f8c4b8c]{grid-template-columns:repeat(6,1fr)}}[data-v-e3f87efc] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-e3f87efc] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-e3f87efc]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--notebook[data-v-e3f87efc]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-e3f87efc]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--page-padding)}.nrdb-layout--notebook>div[data-v-e3f87efc]{width:100%;margin-bottom:var(--group-gap)}.v-card[data-v-e3f87efc]{width:100%}.nrdb-btn-icon{display:flex;align-items:center;justify-content:center}.nrdb-btn-icon .v-btn.v-btn--density-default{height:calc(var(--v-btn-height) + 12px)}.nrdb-ui-button .v-btn .v-icon{--v-icon-size-multiplier: 1}.nrdb-ui-button-group-wrapper[data-v-62fae4d6]{display:flex;flex-direction:row;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.nrdb-ui-button-group-wrapper .v-chip__content[data-v-62fae4d6]{white-space:normal}.nrdb-ui-button-group-wrapper .v-btn-group[data-v-62fae4d6]{width:max-content;border-width:thin;border-color:rgba(var(--v-border-color),var(--v-border-opacity))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated[data-v-62fae4d6]{color:rgb(var(--v-theme-on-group-background));background-color:rgb(var(--v-theme-group-background))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated[data-v-62fae4d6]{--v-activated-opacity: 0}.nrdb-ui-button-group-wrapper .icon-only .v-btn__prepend[data-v-62fae4d6]{margin-inline:0}.nrdb-ui-gauge svg{flex-grow:1;max-width:100%;position:relative}.nrdb-ui-gauge-title{display:block;text-align:center;font-weight:700;font-size:1rem;padding-bottom:4px}.nrdb-ui-gauge-value{position:absolute;width:100%;height:100%;display:flex;align-content:center;justify-content:center;flex-direction:column;text-align:center;flex-wrap:wrap;padding-top:12px}.nrdb-ui-gauge-value span{font-weight:700}.nrdb-ui-gauge-value label{display:flex;align-items:center;justify-content:center}.nrdb-ui-gauge #backdrop path{fill:rgb(var(--v-theme-background))}.nrdb-ui-gauge #sections path{stroke:rgb(var(--v-theme-group-background));stroke-width:2px}.nrdb-ui-gauge #limits{opacity:.5;fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge #needle-container{pointer-events:none}.nrdb-ui-gauge #needle-mask{opacity:0}.nrdb-ui-gauge #needle circle,.nrdb-ui-gauge #needle polygon{fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-value label{font-size:.75rem;line-height:.825rem;gap:4px}.nrdb-ui-gauge-icon-only i{font-size:1.75em}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value span{font-size:1.5rem;line-height:1.75rem}.nrdb-ui-gauge-size-sm .nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value span{font-size:2.5rem;line-height:3rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value label{font-size:1rem;line-height:1.25rem}.nrdb-ui-gauge-size-lg .nrdb-ui-gauge-value span{font-size:3rem;line-height:3.25rem}.nrdb-ui-gauge-tile[data-v-f2a59060]{display:flex;justify-content:center;align-items:center;font-size:2.5rem;font-weight:700;transition:.15s background-color;border:1px solid rgb(var(--v-theme-group-outline))}.nrdb-ui-gauge{position:relative}/*!
  Theme: Default
